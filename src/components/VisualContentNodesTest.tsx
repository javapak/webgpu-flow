...
export const VisualContentNodesTest = () => {
  ...
  return (
    <>
      ...
      <Edge id='bye' data={{label: 'queries'}} sourceNodeId="some-actor" targetNodeId="some-service" userVertices={[{x: -150 , y: -50}]} style={{color: [0,0,0,1], labelColor: '#ffffff', thickness: 2}}/>
